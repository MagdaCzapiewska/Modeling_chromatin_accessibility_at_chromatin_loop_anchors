...
if (length(args) < 2) {
  stop("Błąd: Wymagane są 2 argumenty! Użycie: Rscript script.R <n> <size>")
}
...
# Filtrowanie pod podane z CLI parametry N oraz size ORAZ dokładne wartości MUS
...
# ==============================================================================
# OBLICZANIE I ZAPIS STATYSTYK DLA KOMBINACJI (RHO, MU)
# ==============================================================================
stats_dt <- dt[, .(
  n_datasets         = .N,
...
# ==============================================================================
# WYKRES LINII: MEAN, SD ORAZ DISTANCE VS MU (Z LINIĄ A PRIORI RHO)
# ==============================================================================
...
# ==============================================================================
cat("Generuję PDF z matrycą stabilności korelacji GDM (Rho vs Mu)... \n")
gdm_plots <- list()
