...
if (length(args) < 2) {
  stop("Błąd: Wymagane są 2 argumenty! Użycie: Rscript script.R <rho> <n>")
}

CURRENT_RHO <- args[1]  # np. "-0.4"
CURRENT_N   <- args[2]  # np. "5000"

cat("Uruchamianie dla RHO =", CURRENT_RHO, "| N =", CURRENT_N, "\n")
...
MUS   <- c(1000, 2000, 3000, 4000, 5000)      # Wiersze (mu)
...
# Filtrowanie pod parametry z CLI oraz wektory MUS i SIZES
...
# ==============================================================================
# OBLICZANIE I ZAPIS STATYSTYK DLA KOMBINACJI (MU, SIZE)
# ==============================================================================
stats_dt <- dt[, .(
  n_datasets         = .N,
...
# ==============================================================================
# WYKRES LINII: MEAN, SD ORAZ DISTANCE VS SIZE (DLA KAŻDEGO MU)
# ==============================================================================
...
# ==============================================================================
# GENEROWANIE WYKRESÓW MATRYCY HISTOGRAMÓW (MU vs SIZE)
# ==============================================================================
cat("Generuję PDF z matrycą stabilności korelacji GDM (Mu vs Size)... \n")
gdm_plots <- list()
