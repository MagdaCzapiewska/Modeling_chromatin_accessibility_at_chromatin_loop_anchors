...
OUT_BASE_DIR = os.path.join(RESULTSDIR, "MGLMfit_GDM_cor", "synthetic_data_extended_plus")
...
rule calculate_synthetic_cor_extended:
    input:
        ...
        fit_marker = os.path.join(RESULTSDIR, "MGLMfit_GDM", "synthetic_data_extended_plus", "rho_{rho_str}", "init_{init}", "fit_seed{seed}.done")
    output:
